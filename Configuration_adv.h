...
//JTS
/*
The SERIAL_VERBOSITY_DEFAULT setting controls the level of detail in the console output. The values are:
0: Silent, minimal information.
1: Only errors and critical information.
2: Normal level of information.
3: Detailed information, useful for debugging.
*/
#define SERIAL_VERBOSITY_DEFAULT 3