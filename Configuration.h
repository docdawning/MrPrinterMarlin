...
#define STRING_CONFIG_H_AUTHOR "(contact@jamessnell.com)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Mr. Printer (Ender-3 Pro)"
...
//#define NOZZLE_TO_PROBE_OFFSET {0, 0, 999 }
